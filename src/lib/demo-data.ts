...
export const DEMO_PHOTOGRAPHERS: DemoPhotographer[] = [];
export const DEMO_HAMPERS: DemoCreative[] = [];
export const DEMO_HENNA_DESIGNERS: DemoCreative[] = [];
export const DEMO_MAKEUP_ARTISTS: DemoCreative[] = [];
export const DEMO_CAKE_BAKERS: DemoCreative[] = [];
